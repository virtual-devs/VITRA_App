...
import '../../styles/fontstyles/estilo_registro.dart';

class RegistroViajero extends StatefulWidget {
  const RegistroViajero({super.key});

  @override
  State<RegistroViajero> createState() => _RegistroViajeroState();
}

class _RegistroViajeroState extends State<RegistroViajero> {
